...
export default function SearchFilter({ searchKeyword, onSearchChange }: SearchFilterProps) {
    ...
    (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (value.trim()) {
        analyticsTimeoutRef.current = window.setTimeout(() => {
          trackCustomEvent('location_search', {
  ...
  const handleClearSearch = useCallback(() => {
    ...
    trackCustomEvent('location_search_clear', {
    ...
    <div className='mb-4'>
      ...
      <div className='relative'>
        ...
        <input
          ...
          placeholder='Location, Route, or Pokemon name...'
          className='
