...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 md:top-4 md:bottom-auto right-4 z-50 flex items-center justify-center gap-2 p-2 rounded-full bg-white/80 backdrop-blur-md shadow-sm border border-slate-200 text-slate-700 hover:bg-slate-50 transition-all cursor-pointer group"
